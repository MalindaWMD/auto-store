  ...
  return (
    <div className={ classNames(className,  !plain ? 'shadow-md border rounded-md p-6' : '') }>
      <form action="">
        ...
        <h3 className="mb-3 font-bold">Select your car to search for parts</h3>
        ...
        <button type="button" className="mt-5 w-full rounded-md border border-transparent bg-indigo-600 px-8 py-2 text-center text-white hover:bg-indigo-700 flex items-center justify-center">
