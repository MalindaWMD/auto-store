...
export default function Login() {
  ...
  return (
    <Layout>
      {/* <ModalLoading open={mutation.isPending} /> */}
      <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
            ...
            <FormMessage isShown={mutation.isError} type="error" message={mutation.error?.message} />
            ...
            <form className="space-y-6" action="#" method="POST" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember_me" className="ml-3 block text-sm leading-6 text-gray-900">
                    Remember me
                  </label>
                </div>
              ...
              <div>
                <LoadingButton type="submit" color="indigo" text="Login" isLoading={mutation.isPending}/>
              </div>
            </form>
            ...
            <div>
              ...
              <div className="mt-6">
                <SocialLoginButtons afterLogin={redirectAfterLogin}/>
              </div>
