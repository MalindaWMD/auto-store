...
const subNavigation = [
  ...
  { name: 'Orders', href: '#', icon: CogIcon, current: false },
  { name: 'Orders', href: '#', icon: KeyIcon, current: false },
  { name: 'Wishlist', href: '#', icon: BellIcon, current: false },
  { name: 'Refund', href: '#', icon: CreditCardIcon, current: true },
]
const plans = [
                ...
                <form action="#" method="POST">
                  <div className="shadow sm:overflow-hidden sm:rounded-md">
                    ...
                    <div className="bg-gray-50 px-4 py-3 text-right sm:px-6">
                      <button
                        type="submit"
                        className="inline-flex justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"
                      >
                        Save
                      </button>
                    </div>
